        ...
        <form action="index.php?com=user&act=login" id="validate" class="form" method="post">
            <fieldset>
                <div class="formRow">
                    ...
                    <div class="loginInput"><input type="text" name="username" class="validate[required]" id="username" placeholder="Nhập username" style="background: transparent;border: none;padding: 0;margin-top: 9px;" /></div>
                    <div class="clear"></div>
                </div>
                
                <div class="formRow">
                    <div class="loginInput"><input type="password" name="password" class="validate[required]" id="pass" placeholder="******" style="background: transparent;border: none;padding: 0;margin-top: 9px;" /></div>
                    <div class="clear"></div>
                </div>
